...
//             <img src={movie.img} alt={movie.movieName} style={{ width: '100%', height: '300px', objectFit: 'contain' }} />
//         </div>
//     );
// }
...
//     const filteredMovies = movies.filter(movie => movie.movieName.toLowerCase().includes(searchTerm.toLowerCase()));
...
//     <Link to="/login" style={{ color: 'white', fontWeight: 'bold', marginRight: '20px' }}>Sign In</Link>
//     <Link to="/register" style={{ color: 'white', fontWeight: 'bold', marginRight: '20px' }}>Sign Up</Link>
//     <Link to={`/${userId}/bookings`} style={{ color: 'white', fontWeight: 'bold', marginRight: '20px' }}>My Bookings</Link>
//     <Link to="/register" style={{ color: 'white', fontWeight: 'bold', marginRight: '20px' }}>Sign Up</Link>
//     <Link to="/register" style={{ color: 'white', fontWeight: 'bold', marginRight: '20px' }}>Sign Up</Link>
