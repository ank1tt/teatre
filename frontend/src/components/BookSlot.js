...
import {Input, Space, DatePicker,Card, Pagination} from 'antd';
...
const BookSlot = (props) => 
{
    ...
    //For Pagination
    // const [currentHalls,setCurrentHalls] = useState(null);
    const [currentPage,setCurrentPage] = useState(1);
    const [itemsPerPage,]=useState(5);

    const indexOfLastHall = currentPage * itemsPerPage;
    const indexOfFirstHall = indexOfLastHall - itemsPerPage;
    const currentHalls = uniqueHalls.slice(indexOfFirstHall,indexOfLastHall);
